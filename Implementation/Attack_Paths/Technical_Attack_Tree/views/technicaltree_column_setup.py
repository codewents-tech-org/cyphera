...
def Setup_Tabel_ColumnHeading(self):
    logger.info("Setting up table column headers")
    try:
        ...
        for index, header in enumerate(helper.technicaltree_header):
        ...
        helper.adjust_table_column('TechnicalTree', self.table)

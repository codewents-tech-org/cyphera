...
class SubModuleTabButton(QPushButton):
    ...
    def on_click(self):
        ...
        if SubModuleTabButton.active_button and SubModuleTabButton.active_button != self:
            SubModuleTabButton.active_button.update_style(active=False)

        # Set this button as the active button
        SubModuleTabButton.active_button = self

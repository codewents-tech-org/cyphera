...
from Analysis.Threat_Scenarios.controller.threat_scenario_manager import load_all_threat_scenarios,refresh_threat_scenarios_cache,persist_threat_scenario_changes,delete_threat_scenario,update_threat_scenario
...
class TS_Module(QWidget):
    ...
    def load_data(self):
        ...
        # (Set up headers as you already do...)

        for row_idx, ts in enumerate(threat_scenarios):
            table.insertRow(row_idx)
            # ...set items/cell widgets as before, using ts.xxx fields...
    ...
    def refresh_data(self):
        refresh_threat_scenarios_cache()
        self.load_data()

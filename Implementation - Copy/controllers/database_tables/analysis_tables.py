...
class Threats(Base):
    ...
    name = Column(String, nullable=False)
    ds_id = Column(String, ForeignKey('damage_scenarios.ds_id'), nullable=True)
    toe_configuration_id = Column(String, ForeignKey('toe_configuration.toe_configuration_id'), nullable=True)
    misuse_cases_id = Column(String, ForeignKey('misuse_cases.misuse_cases_id'), nullable=True)
...
class ThreatScenarios(Base):
    ...
    threat_id = Column(String, ForeignKey('threat.threat_id'), nullable=False)
    ds_id = Column(String, ForeignKey('damage_scenarios.ds_id'), nullable=False)
    toe_configuration_id = Column(String, ForeignKey('toe_configuration.toe_configuration_id'), nullable=True)
    reasoning = Column(String, nullable=True)
    comments = Column(String, nullable=True)
    created_by = Column(String, nullable=False)

...
class SecurityControls_Module(QWidget):
    ...
    def load_data(self):
        ...
        try:
            ...
            for idx, obj in enumerate(rows):
                ...
                sidebar = TRI.SidebarWidget(selected=(idx == 0))  # green for first row
                self.table.setCellWidget(idx, 0, sidebar)
                self.row_sidebar_widgets[idx] = sidebar
    ...
    def add_new_entry(self):
        ...
        sidebar = TRI.SidebarWidget(selected=(row_idx == 0))  # green for first row
        self.table.setCellWidget(row_idx, 0, sidebar)
        self.row_sidebar_widgets[row_idx] = sidebar
    ...
    def on_row_selection_changed(self, selected, deselected):
        ...
        for row, widget in self.row_sidebar_widgets.items():

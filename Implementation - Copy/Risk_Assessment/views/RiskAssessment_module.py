...
import Risk_Assessment.Risk_Treatment.views.RiskTreatment_action as RiskTreatment_action
...
class RiskAssessment(QWidget):
    def __init__(self):
        ...
        sidebar_label = QLabel("Risk Assessment") 
        ...
        self.frames = { 
                    'Risk Treatment': RiskTreatment_action.RiskTreatement_Module(),
                }
    ...
    def create_RiskAssessment_buttons(self, layout):
        buttons = [ ('Risk Treatment', lambda: self.show_frame('Risk Treatment')), ]
        ...
        for index, (name, action) in enumerate(buttons):
            ...
            interfaces.riskassessment_sub_modules.append([name, button, action])

            if index == 0:
                interfaces.default_riskassessment_sub_module = interfaces.riskassessment_sub_modules[0]
    ...
    def show_frame(self, frame_name ):
        ...
        #     self.previousmodule = frame
        #     if frame_name == 'Risk Treatment':
        #         interfaces.default_riskassessment_sub_module = interfaces.riskassessment_sub_modules[0]
